<%@ Page Title="Index" Language="C#" MasterPageFile="~/MasterPage2.master" AutoEventWireup="true" CodeFile="index.aspx.cs" Inherits="index" %>
		...
		<div class="tech-no">
            ...
            <asp:ListView ID="ListView1" runat="server">
			 ...
			 <div class="tc-ch">
					...
					<div class="tch-img">
						<a href="singlepage.html"><img src="admin/images/newsimage/<%# Eval("img") %>" style="width: 250px" class="img-responsive" alt=""/></a>
					</div>
					<a class="blog blue" href="singlepage.html">Technology</a>
					<h3><a href="blogview.aspx?id=<%# Eval("id") %>"><%#Eval("heading") %></a></h3>
						 <p><%#Eval("descr") %></p>
					
						<div class="blog-poast-info">
							<ul>
								<li><i class="glyphicon glyphicon-user"> </i><a class="admin" href="#"> Admin </a></li>
								<li><i class="glyphicon glyphicon-calendar"> </i><%#Eval("rts") %></li>
